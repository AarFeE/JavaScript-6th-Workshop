function printCode() {
    const code = ['', '1️⃣    console.log("Inicio del script");', '', '2️⃣    setTimeout(() => {',
        '    console.log("Primer setTimeout");', '    }, 0);', '', '3️⃣    setTimeout(() => {',
        '    console.log("Segundo setTimeout");', '    }, 0);', '',
        '4️⃣    Promise.resolve("Promesa resuelta").then(console.log);', '',
        '5️⃣    console.log("Fin del script");', '    '
    ]
